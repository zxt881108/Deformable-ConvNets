...
def demo_rcnn(cfg, dataset, image_set, root_path, dataset_path,
...
def main():
    ...
    demo_rcnn(config, config.dataset.dataset, config.dataset.test_image_set, config.dataset.root_path, config.dataset.dataset_path,
